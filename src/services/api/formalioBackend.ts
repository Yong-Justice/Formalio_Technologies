import { supabase, isSupabaseConfigured, getSupabaseRuntimeConfig } from '@/services/api/supabase';
import type { Transaction as PrototypeTransaction } from '@/screens/prototype/demoData';
