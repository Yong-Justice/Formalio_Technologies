  ...
  return (
    <Screen>
      <View className="gap-4">
        ...
        <Card className="bg-navy"><Text className="text-sm font-semibold text-white/70">Profit net estimé</Text><Text className="mt-1 text-4xl font-black text-white">845,000 FCFA</Text><Text className="mt-2 text-xs text-white/70">Marge nette 52% · TVA estimée 184K FCFA</Text></Card>
        ...
        <Card title="Insights Mosika AI"><Text className="text-sm leading-6 text-surface-700">• Ventes +23% ce mois.\n• Anomalie transport mercredi.\n• Prévision profit mars: 1.4M FCFA.\n• Économie possible: 45K FCFA/mois.</Text></Card>
        <Button title="Générer rapport comptable IA" />
      </View>
    </Screen>
  );
}